...
export class OrderService {
  ...
  list(params: { search?: string; branch?: number; status?: string; invoice?: string; channel?: string; mine?: boolean; date_from?: string; date_to?: string; page?: number; page_size?: number } = {}): Observable<Paged<Order>> {
