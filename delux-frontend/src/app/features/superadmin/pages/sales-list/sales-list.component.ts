...
@Component({
  ...
  template: `
    ...
    <div class="card p-4 mb-4 flex flex-wrap gap-3 items-center filter-bar">
      <dlx-search-input [fluid]="true" [scanHint]="true" [value]="search()" (valueChange)="onSearch($event)" placeholder="Buscar por código, cliente o producto..." class="flex-1 min-w-64" />
