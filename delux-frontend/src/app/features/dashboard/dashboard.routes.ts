...
export const DASHBOARD_ROUTES: Routes = [
  {
    ...
    children: [
      ...
      { path: 'affiliate/pagos', redirectTo: 'affiliate/payouts' },
      { path: 'affiliate/ventas', redirectTo: 'affiliate/sales' },
      { path: 'affiliate/comisiones', redirectTo: 'affiliate/commissions' },
      {
      ...
      {
        path: 'account',
        canActivate: [roleGuard(['CUSTOMER', 'AFFILIATE', 'SALESPERSON', 'WAREHOUSE', 'BRANCH_MANAGER', 'SUPERADMIN'])],
        children: [
